...
public class Customer {
    ...
    public Customer(int storeId, String firstName, String lastName, String email, int addressId, String password) {
	super();
    ...
    public Customer(long id, String password, int storeId) {
	super();
	this.id = id;
	this.password = password;
	this.storeId = storeId;

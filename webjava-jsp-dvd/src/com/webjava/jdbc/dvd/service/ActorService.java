...
public class ActorService {
    ...
    public List<Actor> findActorByName(String fName, String lName, boolean isFullName) throws ServiceException {
	try {
	    return actorDao.findActorByName(fName, lName, isFullName);
	} catch (DaoException e) {
	    throw new ServiceException(e.getMessage());
	}
    }
    ...
    public List<ActorDetailDTO> findActorDetailbyId(int actorID) throws ServiceException {
	try {
	    return actorDao.findActorDetailbyId(actorID);
	} catch (DaoException e) {
	    throw new ServiceException(e.getMessage());
	}
    }

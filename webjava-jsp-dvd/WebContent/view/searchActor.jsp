...
<c:if test="${empty requestScope.actorList}">
	...
	<form action="${pageContext.request.contextPath}/searchActor"
		method="get">
		Keyword <input type="text" name="keyword" required="required" autocomplete="off" value="${sessionScope.keyword != null? sessionScope.keyword : ''}">
		...
		<table>
			...
			<c:forEach var="actor" items="${actorList}">
				<tr>
					...
					<td>
					 <a href="${pageContext.request.contextPath}/searchActor?detailId=${actor.actorId}"> Detail </a>
					</td>
				</tr>
			</c:forEach>
		</table>

...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/messages.js?v20171114"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/register.js?v20171114"></script>
	<link rel="stylesheet"
	...
	<nav>
		<div class="container">
			<ul>
				...
				<li class="red"><a target="_blank">Register</a></li>
			</ul>
		</div>
	</nav>
</header>
...
<br><br>
	<c:choose>
		...
		<c:otherwise>
	<form action="${pageContext.request.contextPath}/addCustomer" id="regForm">
		<table>
